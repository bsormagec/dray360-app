...
class EquipmentTypesSeeder extends Seeder
{
    ...
    const ALL_COMPANIES = [
        ...
        'LockeTransportation' => [
            'file' => 'seeders/LockeTransportation_EquipmentLeaseTypes.20210914.xlsx',
            'columns' => [
                'tms_equipment_id' => 'id',
                'equipment_owner' => 'line',
                'equipment_type_and_size' => 'type',
        ...
        'JALogistics' => [
            'file' => 'seeders/JALogistics_EquipmentLeaseTypes.20210730.xlsx',
            'columns' => [
                'tms_equipment_id' => 'id',
                'equipment_owner' => 'line',
                'equipment_type_and_size' => 'type',
        ...
        'K1Logistics' => [
            'file' => 'seeders/K1Logistics_EquipmentLeaseTypes.20210622.xlsx',
            'columns' => [
                'tms_equipment_id' => 'id',
                'equipment_owner' => 'line',
                'equipment_type_and_size' => 'type',
