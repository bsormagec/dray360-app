...
class CcContainerTypesImporterTest extends TestCase
{
    ...
    public function it_creates_the_load_types_from_the_endpoint()
    {
            ...
            ->push([
                ...
                'data' => [
                    [
                        'ContainerTypeId' => 1,
                        'OrganizationId' => 4,
                        'ContainerTypeCode' => 'ST',
                        'ContainerType' => 'ST',
                        'ContainerTypeDescription' => 'ST',
                        'InsertedUserId' => 0,
        ...
        $importer = new CcContainerTypesImporter($this->company, [
            'item_type' => DictionaryItem::CC_CONTAINERTYPE_TYPE,
        ...
        $this->assertDatabaseHas('t_dictionary_items', [
            ...
            'item_type' => DictionaryItem::CC_CONTAINERTYPE_TYPE,
            'item_key' => 'ST',
            'item_display_name' => 'ST',
            'item_value->ContainerTypeCode' => 'ST',
            'item_value->ContainerTypeDescription' => 'ST'
        ]);
        $this->assertDatabaseHas('t_dictionary_items', [
            't_company_id' => $this->company->id,
            'item_type' => DictionaryItem::CC_CONTAINERTYPE_TYPE,
            ...
            'item_value->ContainerTypeCode' => 'HC',
            'item_value->ContainerTypeDescription' => 'HC'
        ]);
    }
    ...
    public function it_updates_dictionary_items_if_it_already_exists()
    {
            ...
            ->push([
                ...
                'data' => [
                    [
                        ...
                        'ContainerTypeCode' => 'ST',
                        'ContainerType' => 'ST',
                        'ContainerTypeDescription' => 'ST UPDATED',
                        'InsertedUserId' => 0,
                        'InsertedDate' => '2021-01-07T21:39:00',
                        'UpdatedUserId' => null,
                        'UpdatedDate' => null
        ...
        $this->assertDatabaseHas('t_dictionary_items', [
            ...
            'item_type' => DictionaryItem::CC_CONTAINERTYPE_TYPE,
            'item_key' => 'ST',
            'item_display_name' => 'ST UPDATED',
            'item_value->ContainerTypeCode' => 'ST',
            'item_value->ContainerTypeDescription' => 'ST UPDATED'
        ]);
    }
