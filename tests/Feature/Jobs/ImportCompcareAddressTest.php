...
class ImportCompcareAddressTest extends TestCase
{
    ...
    public function it_inserts_a_new_address_if_it_doesnt_find_an_existing_one()
    {
        ...
        $this->assertDatabaseHas('t_addresses', [
            ...
            'location_name' => "({$addresses[1]['ExternalSystemAddressId']}) ".$addresses[1]['Entity']['EntityName'],
            'location_phone' => null,
            'is_terminal' => 0,
            'is_billable' => 0,
            'is_cc_payor' => 0,
    ...
    public function it_creates_a_new_entry_for_updated_addresses()
    {
        ...
        $this->assertDatabaseHas('t_addresses', [
            ...
            'location_name' => "({$modifiedAddress['ExternalSystemAddressId']}) ".$modifiedAddress['Entity']['EntityName'],
            'location_phone' => null,
            'is_terminal' => 0,
            'is_billable' => 0,
            'is_cc_payor' => 0,
