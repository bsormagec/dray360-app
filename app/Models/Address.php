        ...
        switch ($dataSource) {
            ...
            case 'compcare':
                ...
                return [
                    ...
                    'location_name' => '(' . $data['ExternalSystemAddressId'] . ') ' . Arr::get($data, 'Entity.EntityName'),
                    'location_phone' => null,
                    'is_billable' => 0,
                    'is_terminal' => 0,
    ...
    public function isTheSameAs($address, $source = null): bool
    {
        switch ($source) {
            ...
            case 'compcare':
                ...
                $this->location_name == '(' . $address['ExternalSystemAddressId']  . ') ' . Arr::get($address, 'Entity.EntityName') &&
