...
{
    protected $includesOrders;

    public function __construct(bool $includesOrders = false)
    {
    ...
    public function __invoke(Builder $query, $value, string $property)
    {
        ...
        $query
            ...
            ->when($this->includesOrders, function ($query) use ($values) {
                return $query->leftJoin('t_orders', function ($query) use ($values) {
